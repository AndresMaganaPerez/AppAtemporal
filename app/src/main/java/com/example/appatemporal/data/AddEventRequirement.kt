...
class AddEventRequirement {
    suspend fun AddEvent(event:CrearEventModel,repository:Repository, artista: String, funcion: FunctionModel, userUid: String,boletos: EventoTipoBoletoModel, cid: String) {
